...
export function CanvasNodeHoverToolbar({
    ...
    const imageTools = buildImageToolbarTools(currentNode, { onUpload, onToggleFreeResize, onMaskEdit, onAnnotationEdit, onCrop, onSplit, onUpscale, onSuperResolve, onAngle, onViewImage, onCopyPrompt: copyImagePrompt, onReversePrompt });
